...
//!! JSX
import { CoeurRiskgard } from './CoeurRiskgard.jsx';
import { NavAccueilRiskgard } from './NavAccueilRiskgard.jsx';
...
export function AccueilAnimationRiskgard() {
    ...
    // todo>> variables
    // enregistre l'etat pour afficher le coeur et l'ecg
    const [
        showCoeurRiskgard,
        setCoeurRiskgard
    ] = useState(true);

    // enregistre l'etat pour afficher le menu
    const [
